...
class ECPayController extends Controller
{
    ...
    public function payment(Request $request){
        //include('ee.php');
        //dd( __DIR__ . '/../../Services/ECPay.php',get_include_path());
        include(__DIR__ . '/../../Services/ECPay.php');
        try {
            ...
            $obj->Send['ReturnURL']         = "https://neilsiao.tk/payment/ECPay" ;    //付款完成通知回傳的網址
            ...
            $obj->SendExtend['PaymentInfoURL'] = "https://neilsiao.tk/payment/ECPay"; //伺服器端回傳付款相關資訊。
